...
public class Book_RecyclerViewItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public Book_RecyclerViewItemTouchHelper(int dragDirs, int swipeDirs, ItemTouchHelperListener listener) {
